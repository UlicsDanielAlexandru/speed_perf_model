...
def evaluator(gt_pth_lst, pred_pth_lst, metrics):
    module_map_name = {"Smeasure": "Smeasure", "wFmeasure": "WeightedFmeasure", "MAE": "MAE",
                       ...
                       "meanTP": "Medical", "meanTN": "Medical", "meanFP": "Medical", "meanFN": "Medical"}
    res, metric_module = {}, {}
        ...
        with open(filename, 'w+') as file_to_write:
            ...
            for _model_name in opt.model_lst[0]:
                ...
                for index in range(len(opt.metric_list)):
                    ...
                    if index == 4:
                        print("Dice")
                        print(max_case_score_list[real_max_index[0]])
                    if index == 6:
                        print("TP")
                        print(mean_case_score_list[real_mean_index[0]])
                    if index == 7:
                        print("TN")
                        print(mean_case_score_list[real_mean_index[0]])
                    if index == 8:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=['Smeasure', 'meanEm', 'wFmeasure', 'meanFm', 'maxDice', 'meanSen', 'meanTP', 'meanTN', 'meanFP', 'meanFN'],
    ...
    txt_save_path = '/tmp/work/{}/'.format(opt.txt_name)
